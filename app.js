...
app.get('/users/enable/:id', passportConfig.isAuthenticated, userController.enableUser);
app.get('/users/disable/:id', passportConfig.isAuthenticated, userController.disableUser);
